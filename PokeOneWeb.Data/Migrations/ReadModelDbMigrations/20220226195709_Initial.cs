        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SpriteName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PrimaryElementalType = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SecondaryElementalType = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Attack = table.Column<int>(type: "int", nullable: false),
                    SpecialAttack = table.Column<int>(type: "int", nullable: false),
                    Defense = table.Column<int>(type: "int", nullable: false),
                    SpecialDefense = table.Column<int>(type: "int", nullable: false),
                    ...
                    FemaleRatio = table.Column<decimal>(type: "decimal(6,2)", nullable: false),
                    ...
                    PrimaryAbilityAttackBoost = table.Column<decimal>(type: "decimal(4,1)", nullable: false),
                    PrimaryAbilitySpecialAttackBoost = table.Column<decimal>(type: "decimal(4,1)", nullable: false),
                    PrimaryAbilityDefenseBoost = table.Column<decimal>(type: "decimal(4,1)", nullable: false),
                    PrimaryAbilitySpecialDefenseBoost = table.Column<decimal>(type: "decimal(4,1)", nullable: false),
                    PrimaryAbilitySpeedBoost = table.Column<decimal>(type: "decimal(4,1)", nullable: false),
                    PrimaryAbilityHitPointsBoost = table.Column<decimal>(type: "decimal(4,1)", nullable: false),
                    PrimaryAbilityBoostConditions = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SecondaryAbilityAttackBoost = table.Column<decimal>(type: "decimal(4,1)", nullable: false),
                    SecondaryAbilitySpecialAttackBoost = table.Column<decimal>(type: "decimal(4,1)", nullable: false),
                    SecondaryAbilityDefenseBoost = table.Column<decimal>(type: "decimal(4,1)", nullable: false),
                    SecondaryAbilitySpecialDefenseBoost = table.Column<decimal>(type: "decimal(4,1)", nullable: false),
                    SecondaryAbilitySpeedBoost = table.Column<decimal>(type: "decimal(4,1)", nullable: false),
                    SecondaryAbilityHitPointsBoost = table.Column<decimal>(type: "decimal(4,1)", nullable: false),
                    SecondaryAbilityBoostConditions = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    HiddenAbilityAttackBoost = table.Column<decimal>(type: "decimal(4,1)", nullable: false),
                    HiddenAbilitySpecialAttackBoost = table.Column<decimal>(type: "decimal(4,1)", nullable: false),
                    HiddenAbilityDefenseBoost = table.Column<decimal>(type: "decimal(4,1)", nullable: false),
                    HiddenAbilitySpecialDefenseBoost = table.Column<decimal>(type: "decimal(4,1)", nullable: false),
                    HiddenAbilitySpeedBoost = table.Column<decimal>(type: "decimal(4,1)", nullable: false),
                    HiddenAbilityHitPointsBoost = table.Column<decimal>(type: "decimal(4,1)", nullable: false),
                    HiddenAbilityBoostConditions = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ApplicationDbId = table.Column<int>(type: "int", nullable: false),
                    PokemonVarietyApplicationDbId = table.Column<int>(type: "int", nullable: false),
                    MoveResourceName = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ItemResourceName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ItemName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ItemSpriteName = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HasStab = table.Column<bool>(type: "bit", nullable: false),
                    Accuracy = table.Column<int>(type: "int", nullable: false),
                    PowerPoints = table.Column<int>(type: "int", nullable: false),
                    Priority = table.Column<int>(type: "int", nullable: false),
                    EffectDescription = table.Column<string>(type: "nvarchar(max)", nullable: true),
