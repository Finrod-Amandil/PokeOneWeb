...
{
    public abstract class XSpreadsheetEntityMapper<TDto, TEntity>
        : XISpreadsheetEntityMapper<TDto, TEntity>
        where TEntity : class, IHashedEntity
        where TDto : XISpreadsheetEntityDto
    {
        protected readonly ISpreadsheetImportReporter Reporter;

        protected XSpreadsheetEntityMapper(ISpreadsheetImportReporter reporter)
        {
            Reporter = reporter;
        }
