...
{
    public class MoveTutorXiSheetRepository : XSheetRepository<MoveTutorSheetDto, MoveTutor>
    {
        public MoveTutorXiSheetRepository(
            ApplicationDbContext dbContext,
            XISheetRowParser<MoveTutorSheetDto> parser,
            XISpreadsheetEntityMapper<MoveTutorSheetDto, MoveTutor> mapper,
