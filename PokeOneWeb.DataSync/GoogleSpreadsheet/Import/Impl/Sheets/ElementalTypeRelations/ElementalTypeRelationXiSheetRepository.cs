...
{
    public class ElementalTypeRelationXiSheetRepository :
        XSheetRepository<ElementalTypeRelationSheetDto, ElementalTypeRelation>
    {
        public ElementalTypeRelationXiSheetRepository(
            ApplicationDbContext dbContext,
            XISheetRowParser<ElementalTypeRelationSheetDto> parser,
            XISpreadsheetEntityMapper<ElementalTypeRelationSheetDto, ElementalTypeRelation> mapper,
