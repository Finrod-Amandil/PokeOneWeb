...
{
    public class MoveXiSheetRepository : XSheetRepository<MoveSheetDto, Move>
    {
        public MoveXiSheetRepository(
            ApplicationDbContext dbContext,
            XISheetRowParser<MoveSheetDto> parser,
            XISpreadsheetEntityMapper<MoveSheetDto, Move> mapper,
