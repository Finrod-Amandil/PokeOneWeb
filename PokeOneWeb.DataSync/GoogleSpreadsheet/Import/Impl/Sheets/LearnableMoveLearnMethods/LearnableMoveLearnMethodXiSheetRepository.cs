...
{
    public class LearnableMoveLearnMethodXiSheetRepository
        : XSheetRepository<LearnableMoveLearnMethodSheetDto, LearnableMoveLearnMethod>
    {
        public LearnableMoveLearnMethodXiSheetRepository(
            ApplicationDbContext dbContext,
            XISheetRowParser<LearnableMoveLearnMethodSheetDto> parser,
            XISpreadsheetEntityMapper<LearnableMoveLearnMethodSheetDto, LearnableMoveLearnMethod> mapper,
