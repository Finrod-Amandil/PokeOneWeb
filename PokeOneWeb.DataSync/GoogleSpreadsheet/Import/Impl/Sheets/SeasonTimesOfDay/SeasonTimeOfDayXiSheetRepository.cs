...
{
    public class SeasonTimeOfDayXiSheetRepository : XSheetRepository<SeasonTimeOfDaySheetDto, SeasonTimeOfDay>
    {
        public SeasonTimeOfDayXiSheetRepository(
            ApplicationDbContext dbContext,
            XISheetRowParser<SeasonTimeOfDaySheetDto> parser,
            XISpreadsheetEntityMapper<SeasonTimeOfDaySheetDto, SeasonTimeOfDay> mapper,
