...
{
    public class PokemonXiSheetRepository : XISheetRepository
    {
        private readonly ApplicationDbContext _dbContext;
        private readonly XISheetRowParser<PokemonSheetDto> _parser;
        private readonly XISpreadsheetEntityMapper<PokemonSheetDto, PokemonForm> _mapper;
        private readonly ISpreadsheetImportReporter _reporter;

        public PokemonXiSheetRepository(
            ApplicationDbContext dbContext,
            XISheetRowParser<PokemonSheetDto> parser,
            XISpreadsheetEntityMapper<PokemonSheetDto, PokemonForm> mapper,
