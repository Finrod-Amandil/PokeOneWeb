...
{
    public class RegionXiSheetRepository : XSheetRepository<RegionSheetDto, Region>
    {
        public RegionXiSheetRepository(
            ApplicationDbContext dbContext,
            XISheetRowParser<RegionSheetDto> parser,
            XISpreadsheetEntityMapper<RegionSheetDto, Region> mapper,
