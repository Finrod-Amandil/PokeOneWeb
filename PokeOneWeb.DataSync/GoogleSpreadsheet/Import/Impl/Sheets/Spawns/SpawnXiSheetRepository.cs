...
{
    public class SpawnXiSheetRepository : XSheetRepository<SpawnSheetDto, Spawn>
    {
        public SpawnXiSheetRepository(
            ApplicationDbContext dbContext,
            XISheetRowParser<SpawnSheetDto> parser,
            XISpreadsheetEntityMapper<SpawnSheetDto, Spawn> mapper,
