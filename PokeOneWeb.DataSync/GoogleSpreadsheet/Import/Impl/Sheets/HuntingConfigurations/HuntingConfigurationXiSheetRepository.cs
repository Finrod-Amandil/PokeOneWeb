...
{
    public class HuntingConfigurationXiSheetRepository
        : XSheetRepository<HuntingConfigurationSheetDto, HuntingConfiguration>
    {
        public HuntingConfigurationXiSheetRepository(
            ApplicationDbContext dbContext,
            XISheetRowParser<HuntingConfigurationSheetDto> parser,
            XISpreadsheetEntityMapper<HuntingConfigurationSheetDto, HuntingConfiguration> mapper,
