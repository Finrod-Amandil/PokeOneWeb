...
{
    public class ItemXiSheetRepository : XSheetRepository<ItemSheetDto, Item>
    {
        public ItemXiSheetRepository(
            ApplicationDbContext dbContext,
            XISheetRowParser<ItemSheetDto> parser,
            XISpreadsheetEntityMapper<ItemSheetDto, Item> mapper,
