...
{
    public class EvolutionXiSheetRepository : XSheetRepository<EvolutionSheetDto, Evolution>
    {
        public EvolutionXiSheetRepository(
            ApplicationDbContext dbContext,
            XISheetRowParser<EvolutionSheetDto> parser,
            XISpreadsheetEntityMapper<EvolutionSheetDto, Evolution> mapper,
