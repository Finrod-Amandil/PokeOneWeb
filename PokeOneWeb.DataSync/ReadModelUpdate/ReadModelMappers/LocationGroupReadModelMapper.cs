...
namespace PokeOneWeb.DataSync.ReadModelUpdate.ReadModelMappers
{
    public class LocationGroupReadModelMapper : IReadModelMapper<LocationGroupReadModel>
    {
        ...
        public List<LocationGroupReadModel> MapFromDatabase()
        {
        ...
        private void AttachPreviousAndNext(LocationGroupReadModel readModel, LocationGroup previous, LocationGroup next)
        {
        ...
        private static void SetEventInformation(LocationGroupReadModel readModel, Event regionEvent)
        {
            var dateTimeCulture = CultureInfo.CreateSpecificCulture("en-US");
            var dateTimeFormat = "MMM d, yyyy";
        ...
        private LocationGroupReadModel GetBasicReadModel(LocationGroup lg)
        {
            return new()
            {
