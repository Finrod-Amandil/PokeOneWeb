...
namespace PokeOneWeb.DataSync.Import.SheetMappers
{
    public class PokemonFormSheetMapper : SheetMapper<PokemonForm>
    {
        ...
        protected override Dictionary<string, Action<PokemonForm, object>> ValueToEntityMappings => new()
        {
            ...
            { "Type2", (e, v) => e.PokemonVariety.SecondaryTypeName = v.ParseAsString() },
            { "PrimaryAbility", (e, v) => e.PokemonVariety.PrimaryAbilityName = v.ParseAsNonEmptyString() },
            { "SecondaryAbility", (e, v) => e.PokemonVariety.SecondaryAbilityName = v.ParseAsString() },
            { "HiddenAbility", (e, v) => e.PokemonVariety.HiddenAbilityName = v.ParseAsString() },
            ...
            { "SmogonUrl", (e, v) => AddUrl(e, v.ParseAsString(), "Smogon") },
            { "BulbapediaUrl", (e, v) => AddUrl(e, v.ParseAsString(), "Bulbapedia") },
            { "PokeoneCommunityUrl", (e, v) => AddUrl(e, v.ParseAsString(), "PokeoneCommunity") },
            { "PokemonShowdownUrl", (e, v) => AddUrl(e, v.ParseAsString(), "Pokemon Showdown") },
            { "SerebiiUrl", (e, v) => AddUrl(e, v.ParseAsString(), "Serebii") },
            { "PokemonDbUrl", (e, v) => AddUrl(e, v.ParseAsString(), "PokemonDB") },
