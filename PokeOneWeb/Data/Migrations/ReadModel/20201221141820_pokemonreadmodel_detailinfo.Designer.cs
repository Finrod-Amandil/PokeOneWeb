...
namespace PokeOneWeb.Data.Migrations.ReadModel
{
    ...
    [Migration("20201221141820_pokemonreadmodel_detailinfo")]
    partial class pokemonreadmodel_detailinfo
    {
            ...
            modelBuilder.Entity("PokeOneWeb.Data.ReadModels.AbilityTurnsIntoReadModel", b =>
                {
                    ...
                    b.Property<int?>("PokemonReadModelId1")
                        .HasColumnType("int");

                    b.Property<int?>("PokemonReadModelId2")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("PokemonReadModelId1");

                    b.HasIndex("PokemonReadModelId2");
            ...
            modelBuilder.Entity("PokeOneWeb.Data.ReadModels.AbilityTurnsIntoReadModel", b =>
                {
                    ...
                    b.HasOne("PokeOneWeb.Data.ReadModels.PokemonReadModel", null)
                        ...
                        .HasForeignKey("PokemonReadModelId1");

                    b.HasOne("PokeOneWeb.Data.ReadModels.PokemonReadModel", null)
                        .WithMany("SecondaryAbilityTurnsInto")
                        .HasForeignKey("PokemonReadModelId2");
                });
