...
namespace PokeOneWeb.Services.GoogleSpreadsheet.Impl.Spawn
{
    public class SpawnMapper : ISpreadsheetMapper<SpawnDto, Data.Entities.Spawn>
    {
        ...
        private IDictionary<string, SpawnOpportunity> _spawnOpportunities;
        ...
        public IEnumerable<Data.Entities.Spawn> Map(IEnumerable<SpawnDto> dtos)
        {
            ...
            foreach (var dto in dtos)
            {
                ...
                var spawn = new Data.Entities.Spawn
                {
        ...
        private SpawnOpportunity MapSpawnOpportunity(Season season, TimeOfDay timeOfDay, SpawnDto dto)
        {
            ...
            {
                string probabilityString = dto.SpawnProbability.TrimEnd('%');
                bool canParse = Decimal.TryParse(probabilityString, out var percent);
        ...
        private Data.Entities.Location MapLocation(SpawnDto dto)
        {
