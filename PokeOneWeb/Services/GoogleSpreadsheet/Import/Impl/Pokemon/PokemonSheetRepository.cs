    ...
    public class PokemonSheetRepository : ISheetRepository
    {
        ...
        public int Insert(Dictionary<RowHash, List<object>> rowData)
        {
            ...
            for (var i = 0; i < entities.Count; i++)
            {
                ...
                {
                    _logger.LogWarning($"Could not find availability {entity.Availability.Name} for PokemonForm {entity.Name}, skipping.");
                ...
                var variety = UpdatePokemonVariety(pokemonVariety, entity.PokemonVariety);
            ...
            for (var i = 0; i < entities.Count; i++)
            {
                ...
                {
                    _logger.LogWarning($"Could not find default form {entity.PokemonVariety.DefaultForm.Name} " +
                ...
                {
                    _logger.LogWarning($"Could not find default variety {entity.PokemonVariety.PokemonSpecies.DefaultVariety.Name} " +
                                       $"for PokemonForm {entity.Name}, skipping.");
                    entities.Remove(entity);
                    i--;
                    continue;
        ...
        private PokemonVariety UpdatePokemonVariety(PokemonVariety dbVariety, PokemonVariety newVariety)
        {
            ...
            {
                _logger.LogWarning($"Could not find primary type {newVariety.PrimaryType.Name} for PokemonVariety {newVariety.Name}, skipping.");
                return null;
            }
            ...
            if (newVariety.SecondaryType != null)
            {
                ...
                {
                    _logger.LogWarning($"Could not find secondary type {newVariety.SecondaryType.Name} for PokemonVariety {newVariety.Name}, setting null.");
                }
            }
            ...
            {
                _logger.LogWarning($"Could not find primary ability {newVariety.PrimaryAbility.Name} for PokemonVariety {newVariety.Name}, skipping.");
                return null;
            }
            ...
            if (newVariety.SecondaryAbility != null)
            {
                ...
                {
                    _logger.LogWarning($"Could not find secondary ability {newVariety.SecondaryAbility.Name} for PokemonVariety {newVariety.Name}, setting null.");
                }
            }
            ...
            if (newVariety.HiddenAbility != null)
            {
                ...
                {
                    _logger.LogWarning($"Could not find hidden ability {newVariety.HiddenAbility.Name} for PokemonVariety {newVariety.Name}, setting null.");
                }
            }
            ...
            if (pvpTier is null)
            {
                _logger.LogWarning($"Could not find pvp tier {newVariety.PvpTier.Name} for PokemonVariety {newVariety.Name}, skipping.");
                return null;
            }
