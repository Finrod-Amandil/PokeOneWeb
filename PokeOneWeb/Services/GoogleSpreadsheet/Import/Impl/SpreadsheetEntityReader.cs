...
{
    public abstract class SpreadsheetEntityReader<T> : ISpreadsheetEntityReader<T> where T : ISpreadsheetEntityDto
    {
        private readonly ILogger _logger;

        protected SpreadsheetEntityReader(ILogger logger)
        {
            _logger = logger;
        }
