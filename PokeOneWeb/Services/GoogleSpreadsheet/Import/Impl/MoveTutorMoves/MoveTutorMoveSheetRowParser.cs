...
{
    public class MoveTutorMoveSheetRowParser : ISheetRowParser<MoveTutorMoveDto>
    {
        public MoveTutorMoveDto ReadRow(List<object> values)
        {
            ...
            var value = new MoveTutorMoveDto
            {
