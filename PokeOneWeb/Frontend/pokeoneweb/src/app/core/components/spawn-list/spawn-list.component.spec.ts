import { ISpawnModel, SpawnModel } from '../../models/api/spawn.model';
...
describe('SpawnListComponent', () => {
    ...
    describe('hideEventExclusiveSpawns', () => {
        ...
        it('hideEventExclusiveSpawns with two spawns should hide the one that is an event', () => {
            ...
            // Assert
            expect(component.model.visibleSpawns.length).toBe(1);
            expect(component.model.areOnlyEventExclusiveSpawnsAvailable).toBeFalse;
            expect(component.model.visibleSpawns[0].eventName).toMatch('isNotEvent');
            expect(component.model.areEventExclusiveSpawnsHidden).toBeTrue;
        });
        ...
        it('hideEventExclusiveSpawns with only eventspawns should show all event spawns', () => {
            ...
            // Assert
            expect(component.model.visibleSpawns.length).toBe(2);
            expect(component.model.areOnlyEventExclusiveSpawnsAvailable).toBeTrue;
            expect(component.model.visibleSpawns[0].eventName && component.model.visibleSpawns[1].eventName).toMatch(
                'isEvent'
            );
            expect(component.model.areEventExclusiveSpawnsHidden).toBeTrue;
        });
        ...
        it('hideEventExclusiveSpawns with inactive event no pokemon data', () => {
            ...
            // Assert
            expect(component.model.visibleSpawns.length).toBe(0);
        });
    });
    ...
    describe('showEventExclusiveSpawns', () => {
        ...
        it('showEventExclusiveSpawns with two events one of them being event-exclusive spawns', () => {
            ...
            // Assert
            expect(component.model.visibleSpawns.length).toBe(2);
            expect(component.model.areNoEventSpawnsAvailable).toBeFalse;
            expect(component.model.areOnlyEventExclusiveSpawnsAvailable).toBeFalse;
            expect(component.model.areEventExclusiveSpawnsHidden).toBeFalse;
        });
        ...
        it('showEventExclusiveSpawns with no event spawns', () => {
            ...
            // Assert
            expect(component.model.visibleSpawns.length).toBe(2);
            expect(component.model.areNoEventSpawnsAvailable).toBeTrue;
            expect(component.model.areOnlyEventExclusiveSpawnsAvailable).toBeFalse;
            expect(component.model.areEventExclusiveSpawnsHidden).toBeFalse;
        });
    });
    ...
    describe('checkLocations', () => {
        it('checkLocations() with only one regionName', () => {
            ...
            expect(component.model.hasOnlyOneLocation).toBeTrue;
        });
        it('checkLocations() with multiple regionNames', () => {
            ...
            expect(component.model.hasOnlyOneLocation).toBeFalse;
        });
    });
    ...
    describe('SpawnListSortService', () => {
        it('sortSpawns(SpawnListColumn.Pokemon) test high to low', () => {
            ...
            expect(sortedList[0]).toEqual(spawn1);
        });
        describe('SpawnListSortService', () => {
            it('sortSpawns(SpawnListColumn.Pokemon) test low to high', () => {
                ...
                expect(sortedList[0]).toEqual(spawn2);
            });
        });
    });
