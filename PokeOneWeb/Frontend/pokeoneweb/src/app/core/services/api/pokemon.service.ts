...
export class PokemonService extends BaseService {
    ...
    public getAllPokemonForMoveSet(
        ...
        m21: string | undefined,
        m22: string | undefined,
        m23: string | undefined,
        m24: string | undefined,
        m31: string | undefined,
        m32: string | undefined,
        m33: string | undefined,
        m34: string | undefined,
        m41: string | undefined,
        m42: string | undefined,
        m43: string | undefined,
        m44: string | undefined
    ): Observable<IPokemonVarietyNameModel[]> {
        let url = `${this.url}/getallformoveset?`;
