...
export class ItemListComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        this.itemService.getAll().subscribe((response) => {
            ...
            this.model.displayedItemModels = this.sortService
                .sort(this.model.itemModels, ItemListColumn.Name, 1);
    ...
    public async onFilterChanged() {
        let filtered = await this.filterService
            .applyFilter(this.model.filter, this.model.itemModels);
    ...
    public sort(sortColumn: ItemListColumn, sortDirection: number) {
        ...
        this.model.displayedItemModels = this.sortService
            .sort(this.model.displayedItemModels, sortColumn, sortDirection);
    }
