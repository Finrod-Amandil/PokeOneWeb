...
{
    public class TimeOfDaySheetMapperTest
    {
        private readonly Mock<ISpreadsheetImportReporter> _reporterMock;
        private readonly TimeOfDaySheetMapper _mapper;
        ...
        public TimeOfDaySheetMapperTest()
        {
            _reporterMock = new Mock<ISpreadsheetImportReporter>();
            _mapper = new TimeOfDaySheetMapper(_reporterMock.Object);
        }
        ...
        public void Map_WithMinimalValidValues_ShouldMap()
        {
            ...
            const string name = "TimeOfDay Name";
            const string abbreviation = "M";
        ...
        public void Map_WithMultipleRows_ShouldMap()
        {
            ...
            const string name1 = "TimeOfDay Name 1";
            const string abbreviation1 = "M";

            const int sortIndex2 = 234;
            const string name2 = "TimeOfDay Name 2";
            const string abbreviation2 = "E";
            ...
            var expected = new List<TimeOfDay>
            {
                new()
                {
                    IdHash = _rowHash.IdHash,
        ...
        public void Map_WithMissingRequiredValues_ShouldNotParseAndReportErrors()
        {
            ...
            _reporterMock.Verify(
                x => x.ReportError(nameof(TimeOfDay), _rowHash.IdHash, It.IsAny<Exception>(), It.IsAny<string>()),
                Times.AtLeastOnce);
        }
        ...
        public void Map_WithUnparsableValue_ShouldReportError(params object[] valuesAsArray)
        {
            ...
            actual.Count.Should().Be(0);
            _reporterMock.Verify(
                x => x.ReportError(nameof(TimeOfDay), _rowHash.IdHash, It.IsAny<ParseException>(), It.IsAny<string>()),
                Times.AtLeastOnce);
        }
