...
{
    public class ItemAvailabilitySheetMapperTest
    {
        private readonly Mock<ISpreadsheetImportReporter> _reporterMock;
        private readonly ItemAvailabilitySheetMapper _mapper;
        ...
        public ItemAvailabilitySheetMapperTest()
        {
            _reporterMock = new Mock<ISpreadsheetImportReporter>();
            _mapper = new ItemAvailabilitySheetMapper(_reporterMock.Object);
        }
        ...
        public void Map_WithMinimalValidValues_ShouldMap()
        {
            ...
            var expected = new ItemAvailability
            {
        ...
        public void Map_WithMultipleRows_ShouldMap()
        {
            ...
            var expected1 = new ItemAvailability
            {
                IdHash = _rowHash.IdHash,
                Hash = _rowHash.Hash,
                ImportSheetId = _rowHash.ImportSheetId,
            ...
            var expected2 = new ItemAvailability
            {
                IdHash = _rowHash.IdHash,
                Hash = _rowHash.Hash,
                ImportSheetId = _rowHash.ImportSheetId,
