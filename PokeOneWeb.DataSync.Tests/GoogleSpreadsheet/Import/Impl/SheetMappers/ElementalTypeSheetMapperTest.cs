...
{
    public class ElementalTypeSheetMapperTest
    {
        private readonly Mock<ISpreadsheetImportReporter> _reporterMock;
        private readonly ElementalTypeSheetMapper _mapper;
        ...
        public ElementalTypeSheetMapperTest()
        {
            _reporterMock = new Mock<ISpreadsheetImportReporter>();
            _mapper = new ElementalTypeSheetMapper(_reporterMock.Object);
        }
        ...
        {
            // Arrange
            const string name = "Elemental Type Name";
            ...
            var expected = new ElementalType
            {
        ...
        {
            // Arrange
            const string name1 = "Elemental Type Name 1";

            const string name2 = "Elemental Type Name 2";
            ...
            var expected = new List<ElementalType>
            {
                new()
                {
                    IdHash = _rowHash.IdHash,
